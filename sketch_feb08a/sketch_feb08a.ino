...
void kirim_CAN()
{
  if ((timer%176000>= 0) && (timer%176000 <= 22000)){
    kecepatan = 0;
  }
  else if ((timer%176000>= 22000) && (timer%176000 <= 44000)){
    kecepatan = 10;
  }
  else if ((timer%176000>= 44000) && (timer%176000 <= 66000)){
    kecepatan = 20;
  }
  else if ((timer%176000>= 66000) && (timer%176000 <= 88000)){
    kecepatan = 30;
  }
  else if ((timer%176000>= 88000) && (timer%176000 <= 110000)){
    kecepatan = 40;
  }
  else if ((timer%176000>= 110000) && (timer%176000 <= 132000)){
    kecepatan = 50;
  }
  else if ((timer%176000>= 132000) && (timer%176000 <= 154000)){
    kecepatan = 60;
  }
  else if ((timer%176000>= 154000) && (timer%176000 <= 176000)){
    kecepatan = 70;
  }
